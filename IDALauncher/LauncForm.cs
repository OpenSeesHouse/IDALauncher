...
{
    public partial class LauncForm : Form
    {
        ...
        private void LaunchBtn_Click(object sender, EventArgs e)
        {
            ...
            argv[0] = startIMTB.Text;
            argv[1] = IMStepTB.Text;
            ...
            if (HuntFillRadio.Checked)
            {
                ...
                if (FullRB.Checked)
                {
                    if (NumThreads == 1)
                    {
                        exePath = $"{folder}/FullSingleThreadIDA.exe";
                        argv[4] = NumPntsTB.Text;
                        argv[5] = GoFillCB.Checked ? "1" : "0";
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    {
                        argv[4] = $"{NumThreads}";
                        exePath = $"{folder}/TruncMultiThreadIDA.exe";
                        //exePath = $"{folder}/TruncSingleThreadIDA.exe";
                    }
                    else
                    {
                        argv[4] = $"{NumThreads}";
